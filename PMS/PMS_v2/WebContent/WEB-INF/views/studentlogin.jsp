 ...
 font-size:19px;
  ...
  <body class="container">
	...
	<section id="body" class="container-fluid">
		...
		<h4>${Q}</h4>
		<h2 align="center" style="color:blue"><u>Student Login form</u></h2>
			<form:form class="form-horizontal"  method="post" modelAttribute="student" >
			<br />
			<br />
		<div class="form-group has-error">
			<label for="Name" class="col-sm-2"><i>Student Id :</i> </label>
			<div class="col-sm-8">
				<form:input path="id" class="form-control" placeholder="Enter your Login id"/>
			</div>
		</div>
		<br />
